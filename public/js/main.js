...
},{"_process":2,"dup":1}],29:[function(require,module,exports){
'use strict';
...
},{"vue":28,"vue-hot-reload-api":3}],30:[function(require,module,exports){
'use strict';
...
exports.default = {
   ...
   props: ['label', 'name', 'mandatory', 'content'],
   data: function data() {
      return {};
   },
...
var _formtext = require('./components/formtext.vue');

var _formtext2 = _interopRequireDefault(_formtext);

var _articleSearch = require('./components/articleSearch.vue');

var _articleSearch2 = _interopRequireDefault(_articleSearch);
...
new Vue({
  el: '#app',
  components: { textfield: _formtext2.default,
    articlesearch: _articleSearch2.default
  },
...
},{"./components/articleSearch.vue":29,"./components/formtext.vue":30,"Vue":1,"vue-resource":17}]},{},[31]);
